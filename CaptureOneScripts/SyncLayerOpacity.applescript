(*
SyncLayerOpacity synchronizes the opacity value of non-background layers
...
tell application "Capture One"
	try
		...
		set curLayerOpacity to opacity of curLayer
		...
		repeat with img in selectedImages
			...
			repeat with imgLayer in imgLayers
				if name of imgLayer = curLayerName then
					set opacity of imgLayer to curLayerOpacity
				end if
			end repeat
		end repeat
	on error e
